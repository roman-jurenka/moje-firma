...
const VYCHOZI_EMAIL = {
  email: "",
  predmet: "Cenová nabídka č. {cislo} – {popis}",
  text: [
    "Dobrý den,",
    "",
    "děkujeme za Vaši poptávku a čas, který jste nám věnovali. V příloze Vám zasíláme cenovou nabídku č. {cislo} – {popis}, kterou jsme připravili na míru Vašim potřebám a požadavkům.",
    "",
    "Celková cena: {cena}.",
    "Platnost nabídky: do {plati_do}.",
    "",
    "Rozsah prací, platební podmínky a záruky najdete v přiložené nabídce. Pokud byste chtěli cokoliv upravit nebo se na něco zeptat, zavolejte mi prosím na {telefon} nebo odpovězte na tento e-mail. Rád Vám vše vysvětlím.",
    "",
